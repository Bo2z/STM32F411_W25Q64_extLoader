...
/**
  ...
  *
  */
//#define sFLASH_CS_LOW	 sFLASH_CS_GPIO_Port->BRR = sFLASH_CS_Pin;



#define sFLASH_CS_LOW LL_GPIO_ResetOutputPin(sFLASH_CS_GPIO_Port,sFLASH_CS_Pin);
//#define sFLASH_CS_LOW	 	__ASM("NOP");
/**
  * @brief  Deselect sFLASH: Chip Select pin high
  */
//#define sFLASH_CS_HIGH	sFLASH_CS_GPIO_Port->BSRR = sFLASH_CS_Pin;
#define sFLASH_CS_HIGH LL_GPIO_SetOutputPin(sFLASH_CS_GPIO_Port,sFLASH_CS_Pin);
//#define sFLASH_CS_HIGH		__ASM("NOP");
/**
  * @}
  */ 
